...
class AnimeGrab extends CI_Controller {
  ...
  public function anime_title(){
	...
	public function get($url, $renew = false){
	...
	public function result($json = false, $save = false, $pretty = false){
		...
		return $json ? $pretty ? json_encode($this->data, JSON_PRETTY_PRINT) : json_encode($this->data) : $this->data;
	}
